...
import { theme, Box, Button, AlertDialog, AlertDialogBody, AlertDialogFooter, AlertDialogHeader, AlertDialogContent, AlertDialogOverlay, useDisclosure, Heading, Text, Hide, Show, Input, InputGroup, InputRightElement, useToast, ChakraProvider } from '@chakra-ui/react'
...
function HomePage() {
  ...
  return (
    <ChakraProvider theme={theme}>
      <Box p={5} h={'100vh'} flexDirection="column" bgGradient='linear(to-b, #6320EE, #8075FF, #7e59ca)'>
